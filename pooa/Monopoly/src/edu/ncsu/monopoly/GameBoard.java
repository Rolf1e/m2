...
public class GameBoard {
	...
	public AbstractCell getCell(int newIndex) {
		return (AbstractCell)cells.get(newIndex);
	}
	...
	public AbstractCell queryCell(String string) {
		for(int i = 0; i < cells.size(); i++){
			AbstractCell temp = (AbstractCell)cells.get(i);
